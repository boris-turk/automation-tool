...
namespace BTurk.Automation.Core.WinApi
{
    ...
    public struct LowLevelKeyboardInputEvent
    {
        ...
        /// specified as follows. An application can use the following values to test the keystroke Flags.
        /// Testing LLKHF_INJECTED (bit 4) will tell you whether the event was injected. If it was, then testing
